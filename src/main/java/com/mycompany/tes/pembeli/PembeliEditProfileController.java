...
public class PembeliEditProfileController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        muatDataProfilPembeli();
        btnSave.setOnAction(event -> simpanPerubahanProfil());
    }    

    private void muatDataProfilPembeli() {
        int idPembeli = SesiPengguna.getIdPengguna();
    ...
    private void simpanPerubahanProfil() {
        ...
        try (Connection conn = KoneksiDB.getKoneksi();
            ...
            if (barisTerpengaruh > 0) {
                ...
                tampilkanAlert(AlertType.INFORMATION, "Sukses", "Profil Diperbarui", "Perubahan data profil Anda berhasil disimpan.");
